...
public class DodajKursGUI extends JFrame {
	...
	private void unesiKurs() {
		try {
			GUIKontroler.unesiValutu((Integer) spinnerSifra.getValue(), textFieldNaziv.getText(),
					textFieldSkraceniNaziv.getText(), Double.parseDouble(textFieldKupovniKurs.getText()),
